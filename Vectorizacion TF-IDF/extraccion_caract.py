...
tweets_normalizados = []
with open('tweets_emo_negativas.txt', 'r', encoding='utf-8') as file:
    text = file.read()
#Expresiones regulares para eliminar los usuarios, fechas, enlaces y hashtags
modified_text_1 = re.sub(r'@\w+ ?', '', text)
...
with open('tweets_emonegativas_prepro.txt', 'w', encoding='utf-8') as file:
